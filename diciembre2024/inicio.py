...
import shutil
import json
from libreria import preocess_input_video
...
preocess_input_video(Input_files,Output_files,Backup_files,Log_dir) #Directorios que la aplicacion "Entrada, Sadlida, Respaldo y log de mensajes para analisis"
